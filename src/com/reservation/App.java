...
public class App {
	...
	public static void start(){
		...
		for(Entry<Integer, String> entry : TicketServiceApplication.levelNameMap.entrySet()){
			...
			System.out.println("Level-Number: "+i+" Level-Name: "+levelName+": Seats-Available: "+freeSeatsInLevel+". Price per seat $"+lp.getPricePerSeat()+".00");
			i++;
		}
		...
		if(decision.equals("yes")){
			tsa.reserveSeats(numSeats, userEmail);
			System.out.println("\nSeats have been reserved successfully. Thank you for booking with us.");
			System.out.println("-----------------------------------------------------------------");
			start();
